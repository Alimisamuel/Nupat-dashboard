...
const options = [
  { value: 'chocolate', label: 'May-August' },
  { value: 'strawberry', label: 'June-September' },
  { value: 'vanilla', label: 'July-October' }
]
const stack = [
  { value: 'chocolate', label: 'All' },
  { value: 'chocolate', label: 'Block Chain' },
  { value: 'chocolate', label: 'Full Stack' },
  { value: 'strawberry', label: 'Front End' },
  { value: 'vanilla', label: 'Data Science' },
  { value: 'vanilla', label: 'UI/UX' }
]
